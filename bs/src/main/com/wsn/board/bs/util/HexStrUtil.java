...
public class HexStrUtil {
	...
	public static byte[] parseHexStr2Byte(String s) {
		...
		for(int i = 0; i < s.length()/2; i++){
			buf[i] = parseHexByte(s.substring(i*2, (i + 1) *2));
		}
		return buf;
	}
	...
	public static void main(String[] args){
		...
		String msg = "250400230011FFFFFFFFFFFFFFF000000000000000D602FF0000000000000000FFFF5D";
		char[] c = new char[msg.length()];
		msg.getChars(0, msg.length(), c, 0);
		byte[] buf = decodeHex(c);
//		System.out.println(decodeHex(c));
//		 byte[] buf = parseHexStr2Byte(msg);
//        byte[] buf = new byte[msg.length()];
//        for(int i = 0; i < msg.length(); i+=2) {
//        	buf[i] = Byte.parseByte(msg.substring(i, i+2), 16);
//        }
        for(byte b: buf)
        	System.out.print(b);
//		System.out.println(str2HexStr("250400230011FFFFFFFFFFFFFFF000000000000000D602FF0000000000000000FFFF5D"));
//		System.out.println(hexStr2Str2("250400230011FFFFFFFFFFFFFFF000000000000000D602FF0000000000000000FFFF5D"));
	}
}
